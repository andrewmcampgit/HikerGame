...
{
    public class MidwestChallengerWarehouse
    {
        public static Challenger GetChallenger()
        {
            ...
            Challenger midWestChallenger = challengerList[pickChallenger];

            challengerList.Remove(midWestChallenger);
